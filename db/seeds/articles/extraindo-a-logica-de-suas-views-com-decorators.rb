...
<h3>E como nosso objeto foi decorado? Mágica?</h3>
...
Foi exatamente isso que aconteceu em nosso controller. A variável <code>@articles</code> recebeu uma coleção comum, porém cada item da coleção foi automaticamente decorado no momento em que foi passado para a view.
</p>
